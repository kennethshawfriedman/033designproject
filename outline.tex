...
\begin{document}
	...
	\IEEEtitleabstractindextext{%
		...
		The system contains three modules. The first type of module is the client. A client is any device that wants to wirelessly connect to MIT's network. Examples include laptops, smartphones, and tablets. Each client has a controller, which contains information about the requirements of the given client. The second type of module is the access point, or AP. APs are located throughout MIT's campus, and they contain client information as well as provide network access. Finally, the third module is the server. The server is the central component that stores information and provides instructions.
